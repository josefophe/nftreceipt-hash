...
import NFTCreationComponent from "./NFTCreationComponent"
    ...
    <div className='profile'>
      ...
      <main>
        <form onSubmit={onSubmit}>
          <label className='formLabel'>Sell</label>
...
{/*           {!geolocationEnabled && (
          ...
          <Routes>
           <Route className='App' path="/" element={<CreateCar createCar={createCar} />} />
          </Routes>

          <button type='submit' className='App'>
            Create Listing
          </button>
        </form>
      </main>
