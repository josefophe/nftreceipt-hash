...
function Profile() {
 ...
 // const connectToHedera = new HashConnect(true)
  let hashConnect = new HashConnect()
  const connectToHedera = async (testnet) => {
  ...
  return (
    <div className='profile'>
      ...
      <main>
        ...
        <div>
        <button type='button' className='logOut' onClick={onConnectClick}>ConnectToHashpack</button>
        </div>
